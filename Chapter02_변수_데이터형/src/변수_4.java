...
public class 변수_4 {
	...
	public static void main(String[] args) throws Exception{
        ...
        /*FileReader fis=
        		new FileReader("C:\\javaDev\\javaStudy\\Chapter02_변수_데이터형\\src\\변수_1.java");
        int i=0;
        while((i=fis.read())!=-1)
        {
		...
		int sfklsfkafalskfakflksfklsflksfklhsflkshf=100;
		System.out.println(sfklsfkafalskfakflksfklsflksfklhsflkshf);
